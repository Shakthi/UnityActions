...
namespace CC
{
    public abstract class ActionEase : ActionInterval
    {
        ...
        //Init with Action
        public ActionEase(ActionInterval inner) : base(inner.GetDuration())
        {
            this._inner = inner;
        }
        ...
        public override void StartWithTarget(Transform inTarget)
        {
            ...
            _inner.StartWithTarget(inTarget);
        }
    }
    /** 
  ...
  */
    ...
    public class EaseIn : EaseRateAction
    {
        ...
        public override Action Clone()
        {
            // no copy constructor
            if (_inner != null)
                return new EaseIn((ActionInterval)_inner.Clone(), this.Rate);
            return null;
        }
        public override void LerpAction(float dt)
        {
            _inner.LerpAction(tweenfunc.easeIn(dt, this.Rate));
        }
        public override Action Reverse()
        {
            return new EaseIn((ActionInterval)_inner.Reverse(), 1f / this.Rate);
        }
    };
    /** 
  @class EaseOut
  ...
  */
    public class EaseOut : EaseRateAction
    {
        ...
        public override Action Clone()
        {
            // no copy constructor
            if (_inner != null)
                return new EaseOut((ActionInterval)_inner.Clone(), this.Rate);
            return null;
        }
        public override void LerpAction(float dt)
        {
            _inner.LerpAction(tweenfunc.easeOut(dt, this.Rate));
        }
        public override Action Reverse()
        {
            return new EaseOut((ActionInterval)_inner.Reverse(), 1f / this.Rate);
        }
        public override void StartWithTarget(Transform inTarget)
        {
            base.StartWithTarget(inTarget);
  ...
  */
     ...
     */
        ...
        public override Action Clone()
        {
            // no copy constructor
            if (_inner != null)
                return new EaseInOut((ActionInterval)_inner.Clone(), this.Rate);
            return null;
        }
        public override void LerpAction(float dt)
        {
            _inner.LerpAction(tweenfunc.easeInOut(dt, this.Rate));
        }
        public override Action Reverse()
        {
            return new EaseInOut((ActionInterval)_inner.Reverse(), 1f / this.Rate);
        }
    };
    /** 
    ...
    public class EaseExponentialIn : ActionEase
    {
        ...
        public override Action Clone()
        {
            // no copy constructor
            if (_inner != null)
                return new EaseExponentialIn((ActionInterval)_inner.Clone());
            return null;
        }
        public override void LerpAction(float dt)
        {
            _inner.LerpAction(tweenfunc.expoEaseIn(dt));
        }
        public override Action Reverse()
        {
            return new EaseExponentialIn((ActionInterval)_inner.Reverse());
        }
    };
    /** 
  ...
  */
     ...
     */
        ...
        public override Action Clone()
        {
            // no copy constructor
            if (_inner != null)
                return new EaseExponentialOut((ActionInterval)_inner.Clone());
            return null;
        }
        public override void LerpAction(float dt)
        {
            _inner.LerpAction(tweenfunc.expoEaseOut(dt));
        }
        public override Action Reverse()
        {
            return new EaseExponentialOut((ActionInterval)_inner.Reverse());
        }
    };
    /** 
    ...
    public class EaseExponentialInOut : ActionEase
    {
        ...
        public override Action Clone()
        {
            // no copy constructor
            if (_inner != null)
                return new EaseExponentialInOut((ActionInterval)_inner.Clone());
            return null;
        }
        public override void LerpAction(float dt)
        {
            _inner.LerpAction(tweenfunc.expoEaseInOut(dt));
        }
        public override Action Reverse()
        {
            return new EaseExponentialInOut((ActionInterval)_inner.Reverse());
        }
    };
    /** 
  @class EaseElastic
  ...
  */
     ...
     */
        ...
        public override Action Clone()
        {
            // no copy constructor
            if (_inner != null)
                return new EaseElasticIn((ActionInterval)_inner.Clone(), this.Period);
            return null;
        }
        public override Action Reverse()
        {
            return new EaseElasticIn((ActionInterval)_inner.Reverse(), this.Period);
        }
    };
     ...
     */
        ...
        public override Action Clone()
        {
            // no copy constructor
            if (_inner != null)
                return new EaseElasticOut((ActionInterval)_inner.Clone(), this.Period);
            return null;
        }
        public override Action Reverse()
        {
            return new EaseElasticOut((ActionInterval)_inner.Reverse(), this.Period);
        }
    };
     ...
     */
        ...
        public override Action Clone()
        {
            // no copy constructor
            if (_inner != null)
                return new EaseElasticInOut((ActionInterval)_inner.Clone(), this.Period);
            return null;
        }
        public override Action Reverse()
        {
            return new EaseElasticInOut((ActionInterval)_inner.Reverse(), this.Period);
        }
    };
    ...
    public class EaseBounceIn : ActionEase
    {
        ...
        public override void LerpAction(float dt)
        {
            _inner.LerpAction(tweenfunc.bounceEaseIn(dt));
        }
        public override Action Clone()
        {
            // no copy constructor
            if (_inner != null)
                return new EaseBounceIn((ActionInterval)_inner.Clone());
            return null;
        }
        public override Action Reverse()
        {
            return new EaseBounceIn((ActionInterval)_inner.Reverse());
        }
    };
    public class EaseBounceOut : ActionEase
    {
        ...
        public override void LerpAction(float dt)
        {
            _inner.LerpAction(tweenfunc.bounceEaseOut(dt));
        }
        public override Action Clone()
        {
            // no copy constructor
            if (_inner != null)
                return new EaseBounceOut((ActionInterval)_inner.Clone());
            return null;
        }
        public override Action Reverse()
        {
            return new EaseBounceOut((ActionInterval)_inner.Reverse());
        }
    };
    public class EaseBounceInOut : ActionEase
    {
        ...
        public override void LerpAction(float dt)
        {
            _inner.LerpAction(tweenfunc.bounceEaseInOut(dt));
        }
        public override Action Clone()
        {
            // no copy constructor
            if (_inner != null)
                return new EaseBounceInOut((ActionInterval)_inner.Clone());
            return null;
        }
        public override Action Reverse()
        {
            return new EaseBounceInOut((ActionInterval)_inner.Reverse());
        }
    };
    /** 
  @class EaseBackIn
  ...
  */
     ...
     */
        ...
        public override void LerpAction(float dt)
        {
            _inner.LerpAction(tweenfunc.backEaseIn(dt));
        }
        public override Action Clone()
        {
            // no copy constructor
            if (_inner != null)
                return new EaseBackIn((ActionInterval)_inner.Clone());
            return null;
        }
        public override Action Reverse()
        {
            return new EaseBackIn((ActionInterval)_inner.Reverse());
        }
    };
    /** 
  @class EaseBackOut
  ...
  */
     ...
     */
        ...
        public override void LerpAction(float dt)
        {
            _inner.LerpAction(tweenfunc.backEaseOut(dt));
        }
        public override Action Clone()
        {
            // no copy constructor
            if (_inner != null)
                return new EaseBackOut((ActionInterval)_inner.Clone());
            return null;
        }
        public override Action Reverse()
        {
            return new EaseBackOut((ActionInterval)_inner.Reverse());
        }
    };
    /** 
  @class EaseBackInOut
  ...
  */
     ...
     */
        ...
        public override void LerpAction(float dt)
        {
            _inner.LerpAction(tweenfunc.backEaseInOut(dt));
        }
        public override Action Clone()
        {
            // no copy constructor
            if (_inner != null)
                return new EaseBackInOut((ActionInterval)_inner.Clone());
            return null;
        }
        public override Action Reverse()
        {
            return new EaseBackInOut((ActionInterval)_inner.Reverse());
        }
    };
    /** 
...
*/
     ...
     */
        ...
        public override void LerpAction(float dt)
        {
            _inner.LerpAction(tweenfunc.bezieratFunction(_p0, _p1, _p2, _p3, dt));
        }
        public override Action Clone()
        {
            // no copy constructor
            if (_inner != null)
            {
                EaseBezierAction action = new EaseBezierAction((ActionInterval)_inner.Clone());
...
*/
    public class EaseQuadraticActionIn : ActionEase
    {
        ...
        public override void LerpAction(float dt)
        {
            _inner.LerpAction(tweenfunc.quadEaseIn(dt));
        }
        public override Action Clone()
        {
            // no copy constructor
            if (_inner != null)
                return new EaseQuadraticActionIn((ActionInterval)_inner.Clone());
            return null;
        }
        public override Action Reverse()
        {
            return new EaseQuadraticActionIn((ActionInterval)_inner.Reverse());
        }
    };
    /** 
...
*/
     ...
     */
        ...
        public override void LerpAction(float dt)
        {
            _inner.LerpAction(tweenfunc.quadEaseOut(dt));
        }
        public override Action Clone()
        {
            // no copy constructor
            if (_inner != null)
                return new EaseQuadraticActionOut((ActionInterval)_inner.Clone());
            return null;
        }
        public override Action Reverse()
        {
            return new EaseQuadraticActionOut((ActionInterval)_inner.Reverse());
        }
    };
    /** 
...
*/
     ...
     */
        ...
        public override void LerpAction(float dt)
        {
            _inner.LerpAction(tweenfunc.quadEaseInOut(dt));
        }
        public override Action Clone()
        {
            // no copy constructor
            if (_inner != null)
                return new EaseQuadraticActionInOut((ActionInterval)_inner.Clone());
            return null;
        }
        public override Action Reverse()
        {
            return new EaseQuadraticActionInOut((ActionInterval)_inner.Reverse());
        }
    };
    /** 
...
*/
     ...
     */
        ...
        public override void LerpAction(float dt)
        {
            _inner.LerpAction(tweenfunc.quartEaseIn(dt));
        }
        public override Action Clone()
        {
            // no copy constructor
            if (_inner != null)
                return new EaseQuarticActionIn((ActionInterval)_inner.Clone());
            return null;
        }
        public override Action Reverse()
        {
            return new EaseQuarticActionIn((ActionInterval)_inner.Reverse());
        }
    };
    /** 
...
*/
     ...
     */
        ...
        public override Action Clone()
        {
            // no copy constructor
            if (_inner != null)
                return new EaseQuarticActionOut((ActionInterval)_inner.Clone());
            return null;
        }
        public override Action Reverse()
        {
            return new EaseQuarticActionOut((ActionInterval)_inner.Reverse());
        }
    };
    /** 
...
*/
     ...
     */
        ...
        public override void LerpAction(float dt)
        {
            _inner.LerpAction(tweenfunc.quartEaseInOut(dt));
        }
        public override Action Clone()
        {
            // no copy constructor
            if (_inner != null)
                return new EaseQuarticActionInOut((ActionInterval)_inner.Clone());
            return null;
        }
        public override Action Reverse()
        {
            return new EaseQuarticActionInOut((ActionInterval)_inner.Reverse());
        }
    };
     ...
     */
        ...
        public override void LerpAction(float dt)
        {
            _inner.LerpAction(tweenfunc.quintEaseIn(dt));
        }
        public override Action Clone()
        {
            // no copy constructor
            if (_inner != null)
                return new EaseQuinticActionIn((ActionInterval)_inner.Clone());
            return null;
        }
        public override Action Reverse()
        {
            return new EaseQuinticActionIn((ActionInterval)_inner.Reverse());
        }
    };
     ...
     */
        ...
        public override void LerpAction(float dt)
        {
            _inner.LerpAction(tweenfunc.quintEaseOut(dt));
        }
        public override Action Clone()
        {
            // no copy constructor
            if (_inner != null)
                return new EaseQuinticActionOut((ActionInterval)_inner.Clone());
            return null;
        }
        public override Action Reverse()
        {
            return new EaseQuinticActionOut((ActionInterval)_inner.Reverse());
        }
    };
     ...
     */
        ...
        public override void LerpAction(float dt)
        {
            _inner.LerpAction(tweenfunc.quintEaseInOut(dt));
        }
        public override Action Clone()
        {
            // no copy constructor
            if (_inner != null)
                return new EaseQuinticActionInOut((ActionInterval)_inner.Clone());
            return null;
        }
        public override Action Reverse()
        {
            return new EaseQuinticActionInOut((ActionInterval)_inner.Reverse());
        }
    };
     ...
     */
        ...
        public override void LerpAction(float dt)
        {
            _inner.LerpAction(tweenfunc.circEaseIn(dt));
        }
        public override Action Clone()
        {
            // no copy constructor
            if (_inner != null)
                return new EaseCircleActionIn((ActionInterval)_inner.Clone());
            return null;
        }
        public override Action Reverse()
        {
            return new EaseCircleActionIn((ActionInterval)_inner.Reverse());
        }
    };
     ...
     */
        ...
        public override void LerpAction(float dt)
        {
            _inner.LerpAction(tweenfunc.circEaseOut(dt));
        }
        public override Action Clone()
        {
            // no copy constructor
            if (_inner != null)
                return new EaseCircleActionOut((ActionInterval)_inner.Clone());
            return null;
        }
        public override Action Reverse()
        {
            return new EaseCircleActionOut((ActionInterval)_inner.Reverse());
        }
    };
     ...
     */
        ...
        public override void LerpAction(float dt)
        {
            _inner.LerpAction(tweenfunc.circEaseInOut(dt));
        }
        public override Action Clone()
        {
            // no copy constructor
            if (_inner != null)
                return new EaseCircleActionInOut((ActionInterval)_inner.Clone());
            return null;
        }
        public override Action Reverse()
        {
            return new EaseCircleActionInOut((ActionInterval)_inner.Reverse());
        }
    };
     ...
     */
        ...
        public override void LerpAction(float dt)
        {
            _inner.LerpAction(tweenfunc.cubicEaseIn(dt));
        }
        public override Action Clone()
        {
            // no copy constructor
            if (_inner != null)
                return new EaseCubicActionIn((ActionInterval)_inner.Clone());
            return null;
        }
        public override Action Reverse()
        {
            return new EaseCubicActionIn((ActionInterval)_inner.Reverse());
        }
    };
     ...
     */
        ...
        public override void LerpAction(float dt)
        {
            _inner.LerpAction(tweenfunc.cubicEaseOut(dt));
        }
        public override Action Clone()
        {
            // no copy constructor
            if (_inner != null)
                return new EaseCubicActionOut((ActionInterval)_inner.Clone());
            return null;
        }
        public override Action Reverse()
        {
            return new EaseCubicActionOut((ActionInterval)_inner.Reverse());
        }
    };
     ...
     */
        ...
        public override void LerpAction(float dt)
        {
            _inner.LerpAction(tweenfunc.cubicEaseInOut(dt));
        }
        public override Action Clone()
        {
            // no copy constructor
            if (_inner != null)
                return new EaseCubicActionInOut((ActionInterval)_inner.Clone());
            return null;
        }
        public override Action Reverse()
        {
            return new EaseCubicActionInOut((ActionInterval)_inner.Reverse());
        }
    };
}
